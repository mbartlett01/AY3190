...
def only_evens_numpy(input_array):
    '''Takes in an array and returns an array with only the even values'''
    bool_array = input_array % 2 == 0
    return input_array[bool_array]
